					...
					<li class="dropdown">
						...
						<ul class="dropdown-menu" role="menu">
							<li role="presentation">
								<a href="<?php echo site_url('pengaturan/edit_password');?>" role="menuitem">
				...
				<div>
					<ul class="site-menu">
						...
						<li class='site-menu-item'>
							<a href='<?php echo site_url('admin');?>' class='animsition-link'>
						...
						<li class='site-menu-item'>
							<a href='<?php echo site_url('website/identitas/edit/1');?>' class='animsition-link'>
						...
						<li class='site-menu-item has-sub'>
							...
							<ul class='site-menu-sub'>
								<li class='site-menu-item'>
									<a href='<?php echo site_url('pengaturan/pengguna');?>' class='animsition-link'>
								...
								<li class='site-menu-item'>
									<a href='<?php echo site_url('website/supplier');?>' class='animsition-link'>
										<i class='site-menu-icon fa fa-angle-right'></i>
										<span class='site-menu-title'>
											Supplier
										</span>
								...
								<li class='site-menu-item'>
									<a href='<?php echo site_url('website/customer');?>' class='animsition-link'>
										<i class='site-menu-icon fa fa-angle-right'></i>
										<span class='site-menu-title'>
											Customer
										</span>
						...
						<li class='site-menu-item'>
							<a href='<?php echo site_url('website/barang');?>' class='animsition-link'>
						...
						<li class='site-menu-item'>
							<a href='<?php echo site_url('website/stock/edit/1');?>' class='animsition-link'>
						...
						<li class='site-menu-item has-sub'>
							...
							<ul class='site-menu-sub'>
								<?php if($admin->admin_level_kode === '1' || $admin->admin_level_kode === '2') {?>
								<li class='site-menu-item'>
									<a href='<?php echo site_url('website/masuk');?>' class='animsition-link'>
										<i class='site-menu-icon fa fa-angle-right'></i>
										<span class='site-menu-title'>
										Incoming Goods
										</span>
								...
								<?php if($admin->admin_level_kode === '1' || $admin->admin_level_kode === '3') {?>
								<li class='site-menu-item'>
									<a href='<?php echo site_url('website/keluar');?>' class='animsition-link'>
										<i class='site-menu-icon fa fa-angle-right'></i>
										<span class='site-menu-title'>
										Outgoing Goods
										</span>
								...
								<li class='site-menu-item'>
									<a href='<?php echo site_url('website/penyesuaian');?>' class='animsition-link'>
										<i class='site-menu-icon fa fa-angle-right'></i>
										<span class='site-menu-title'>
											Adjustment
										</span>
						...
						<li class='site-menu-item has-sub'>
							...
							<ul class='site-menu-sub'>
								<li class='site-menu-item'>
									<a href='<?php echo site_url('website/laporanmasuk');?>' class='animsition-link'>
										<i class='site-menu-icon fa fa-angle-right'></i>
										<span class='site-menu-title'>
										Incoming Goods
										</span>
								...
								<li class='site-menu-item'>
									<a href='<?php echo site_url('website/laporankeluar');?>' class='animsition-link'>
										<i class='site-menu-icon fa fa-angle-right'></i>
										<span class='site-menu-title'>
										Outgoing Goods
										</span>
								...
								<li class='site-menu-item'>
									<a href='<?php echo site_url('website/laporanpenyesuaian');?>' class='animsition-link'>
										<i class='site-menu-icon fa fa-angle-right'></i>
										<span class='site-menu-title'>
										 Adjustment
										</span>
