    ...
    series: [{
        ...
        data: [
			...
			<?php } ?>
						...
						<a href="<?php echo site_url('website/laporanmasukpdf');?>" class="btn btn-success btn-block btn-lg" style="margin-top: 30px !important;">Download Incoming Goods Report PDF</a>
                </div>
            </div>
        </div>
    </div>
