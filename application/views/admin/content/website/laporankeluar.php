    ...
    series: [{
        ...
        data: [
			...
			<?php } ?>
                ...
                </div><a href="<?php echo site_url('website/laporankeluarpdf');?>" class="btn btn-success btn-block btn-lg" style="margin-top: 30px !important;">Download PDF Outgoing Goods Report</a>
            </div>
        </div>
    </div>
    </div>
